...
# q2_choice1 = pygame.image.load("projects\PyGame\pictures\start.png")
# q2_choice2 = pygame.image.load("projects\PyGame\pictures\exit.png")
# q2_choice3 = pygame.image.load("projects\PyGame\pictures\exit.png")
# q2_choice4 = pygame.image.load("projects\PyGame\pictures\exit.png")


# ============================== QUIZ 3 ====================================

# q3_choice1 = pygame.image.load("projects\PyGame\pictures\start.png")
# q3_choice2 = pygame.image.load("projects\PyGame\pictures\exit.png")
# q3_choice3 = pygame.image.load("projects\PyGame\pictures\exit.png")
# q3_choice4 = pygame.image.load("projects\PyGame\pictures\exit.png")
# ============================== QUIZ 4 ====================================

# q4_choice1 = pygame.image.load("projects\PyGame\pictures\start.png")
# q4_choice2 = pygame.image.load("projects\PyGame\pictures\exit.png")
# q4_choice3 = pygame.image.load("projects\PyGame\pictures\exit.png")
# q4_choice4 = pygame.image.load("projects\PyGame\pictures\exit.png")

# ============================== QUIZ 5 ====================================

# q5_choice1 = pygame.image.load("projects\PyGame\pictures\start.png")
# q5_choice2 = pygame.image.load("projects\PyGame\pictures\exit.png")
# q5_choice3 = pygame.image.load("projects\PyGame\pictures\exit.png")
# q5_choice4 = pygame.image.load("projects\PyGame\pictures\exit.png")
...
def init_timmie():
    ...
    timmieAni = ClassAnimeTimmie(200, 200)
...
#   global button_true, button_false
    ...
    # timmie = quizTimmie(200, 200)
    # timmie.draw()
    # choice1 = ClassGameButton(150, 350, q2_choice1, q2_choice1.get_width(), q2_choice1.get_height(), 0.75)
    # choice2 = ClassGameButton(475, 350, q2_choice2, q2_choice2.get_width(), q2_choice2.get_height(), 0.75)
    # choice3 = ClassGameButton(475, 350, q2_choice3, q2_choice3.get_width(), q2_choice3.get_height(), 0.75)
    # choice4 = ClassGameButton(475, 350, q2_choice4, q2_choice4.get_width(), q2_choice4.get_height(), 0.75)
    # buttonsGameGroup.draw(screen)
...
def main_quiz2():
    ...
    #                 button_true.updateGameBt()
    #                 button_false.updateGameBt()
    #                 print("true")
    #                 screen.blit(bg4, (0, 0))
