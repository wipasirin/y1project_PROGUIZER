...
class mary(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load("projects\PyGame\pictures\mary2.png")
    ...
    def update(self):
        ...
        if (keypress[pygame.K_d]): # if user press 'd' -- move right
            self.image = pygame.image.load("projects\PyGame\pictures\mary3.png")
            self.speedx = +5
        elif (keypress[pygame.K_a]): # if user press 'a' -- move left
            self.image = pygame.image.load("projects\PyGame\pictures\mary4.png")
            # pygame.time.delay(10)
            self.speedx = -5
        elif (keypress[pygame.K_w]): # if user press 'w' -- move up
            self.image = pygame.image.load("projects\PyGame\pictures\mary5.png")
            self.speedy = -5
